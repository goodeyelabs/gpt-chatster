...
export default function Messages() {
    ...
    if (list[activeSession]) {
        return (
            <div className='grid pb-[var(--sub-header-height)] items-start content-start w-full px-5 sm:px-8 md:px-12 lg:px-16 xl:px-32 bg-white dark:bg-redax'>
                {
                                ...
                                <div 
                                    ...
                                    <div className='grid gap-2 w-[90%] place-self-start justify-start justify-items-start py-4'>
                                        <div className='grid bg-slate-200/40 dark:bg-redax-light rounded-[10px] px-2.5 md:px-3 xl:px-4'>
                                            <p className='text-sm font-base leading-relaxed text-neutral-900 dark:text-stone-300 py-2'>
