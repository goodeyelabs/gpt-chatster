    ...
    return (
        <div className='grid gap-3 grid-cols-[auto_auto_1fr] md:grid-cols-[auto_1fr] h-[var(--header-height)] px-5 md:px-6 xl:px-8 bg-white items-center'>
            ...
            <div className='grid grid-flow-col items-center gap-3'>
                ...
                />
                <p className='grid grid-flow-col text-xl text-gray-900 font-bold tracking-slight'>Redax<span className='tracking-tight font-light pl-0.5 text-transparent bg-clip-text bg-gradient-to-tr from-[var(--color-light-blue)] to-[var(--color-pink-red)]'>GPT</span></p> 
            </div>
