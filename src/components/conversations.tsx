                ...
                !searchTerm && list.map((c:any, c_idx:number) => {
                    ...
                    return (
                        <div 
                            ...
                            className={`grid px-5 md:px-6 xl:px-8 transition-all duration-0 ease-in-out ${activeSession === c.sessionID ? 'bg-slate-100 dark:bg-redax-light hover:bg-slate-100  dark:hover:bg-redax-light cursor-default' : ' hover:bg-slate-100 dark:hover:bg-redax-light cursor-pointer'}`}
                        >
