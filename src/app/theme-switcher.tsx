...
export default function ThemeSwitcher() {
    ...
    if (mounted) {
        return (
            <div onClick={() => setTheme((theme === 'light' || theme === 'system') ? 'dark' : 'light')} className='group transition-all duration-75 items-center cursor-pointer hidden md:grid select-none'>
                {
                    theme === 'light' &&
